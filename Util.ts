...
export class Subject {
    ...
    constructor(subjectCode:String,sem:number,lectureCount:number,isPractical:boolean){
        ...
        this.sem //semester of this subject
        this.lectureCount //total no. of lectures alloted to this subject
        this.isPractical //if false then the subject is theory otherwise practical
    }
}